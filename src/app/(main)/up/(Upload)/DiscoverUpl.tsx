...
interface DiscoverUplProps {
  locationData: {
    location: string | null;
  };
}
const DiscoverUpl: React.FC<DiscoverUplProps> = ({ locationData }) => {
  ...
  const handleUpload = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("/api/Upload/Discoverupload", {
